...
/// \file  prc_buildinfo.h
///
/// Last changed by = $Author: doug $
/// Last changed date = $Date: 2012-03-21 15:13:36 -0500 (Wed, 21 Mar 2012) $
/// Lastest revision = $Revision: 1698 $



#ifndef PRC_BUILDINFO_H__
#define PRC_BUILDINFO_H__
