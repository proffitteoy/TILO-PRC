...
namespace PRC
{
   template<typename T, typename S> int knnSimSparseMatrix(const T &data, S &result, int k, KNN_ADJ_MODE mode, double sigma=-1.0);
}

#include<prc/internal/internal_knnsimSparse.h>
